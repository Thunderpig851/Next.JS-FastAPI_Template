...
from app.serializers.userSerializers import userEntity, userListEntity
...
async def create_user(payload: schemas.CreateUserSchema, request: Request):
    ...
    # Correct _id bson formatting
    new_user['_id'] = utils.parse_json(new_user['_id'])
...
def get_accounts():
    accounts = []
    # Omit _id on return to avoid errors
